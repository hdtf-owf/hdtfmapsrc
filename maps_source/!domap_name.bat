...
"%GAME_DIR%\bin\vbsp.exe" -game "%VPROJECT%" %MAPNAME%.vmf
color 05
ECHO.
ECHO.
ECHO.
...
ECHO.
title %MAPNAME% - VRAD
rem "%GAME_DIR%\bin\vrad.exe" -threads %CORE% -ldr -ambientocclusion -aosamples 32 -worldtextureshadows -translucentshadows -final -game "%VPROJECT%" %MAPNAME%.bsp
